...
/// <summary>
/// M5 end-to-end test for the controller-side remote editor services. Launches the unmodified test target with
...
{
    private const string TargetNamespace = "CSharpRepl.Inspector.TestTarget";
