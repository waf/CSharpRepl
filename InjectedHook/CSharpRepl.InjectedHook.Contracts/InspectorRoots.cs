...
/// instance. It is populated with the target's root <see cref="IServiceProvider"/> (ASP.NET
/// <c>IStartupFilter</c> or Generic Host <c>DiagnosticListener</c>) when one is captured; otherwise it is
/// null and only statics/framework code are reachable.
/// </summary>
